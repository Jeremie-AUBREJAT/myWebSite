...
<body class="font-sans bg-zinc-800">
    ...
    <div style="background-image: url('asset/img/background3.png');" class="rounded-l-2xl lg:m-32 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        ...
        <section  class="py-16 bg-gray-400 rounded-l-2xl bg-opacity-95" >
                <div id="moveright" class="container mx-auto text-center">
                    <h2 id= left class="inline-block px-16 py-2 bg-gray-800 text-white rounded-lg text-2xl font-semibold">J@B WEB</h2>
                    <div class="container mx-auto p-4 sm:p-8 md:p-12 lg:p-16 xl:p-20">
                    <div id= left class="bg-gray-100 shadow-xl p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl leading-relaxed rounded-2xl">
