...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
    ...
    <section class="py-16 bg-gray-400">
            <div class="container mx-auto text-center">
                <h2 class="text-2xl font-semibold">J@B WEB</2>
                <div class="container mx-auto p-4 sm:p-8 md:p-12 lg:p-16 xl:p-20">
                <div class="bg-gray-100 shadow-xl p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl leading-relaxed rounded-lg">
                     Vous souhaite bienvenue dans le monde de l'innovation numérique ! En tant que développeur web freelance passionné, je m'engage à transformer vos idées en réalité. 
                    Avec une expertise approfondie dans les dernières technologies web, je suis prêt à concevoir des solutions sur mesure qui répondent précisément à vos besoins. 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
                ...
                <h3 class="text-lg font-semibold"><a href="http://http://localhost/ExamRestor/" target="_blank">leptitfut.fr</a></h3> 
                        <a href="http://localhost/ExamRestor/" target="_blank">leptitfut.fr
                            <img src="asset/img/ptitfut.jpg" class="w-1/4 mx-auto rounded-lg transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none shadow-xl" alt="Description de l'image">
                         </a>
    ...
    <div class="flex justify-center items-center h-2/3 bg-gray-400">
        <div class="bg-gray-100 p-4 rounded-lg shadow-2xl w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/3 text-center">
